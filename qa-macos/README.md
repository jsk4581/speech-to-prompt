...
한국어 문장 사이에 영어 식별자를 섞어 말한 38초입니다. **화자가 의도적으로 또박또박
발음한 테이크**로, "발음이 뭉개져서 그런 것 아니냐"를 배제하려고 다시 녹음한 것입니다.
`STP_KEEP_AUDIO=1` 로 헬퍼가 남긴 캡처를 그대로 옮겼습니다.
...
- 또렷하게 발음해도 식별자 11개 중 기본 설정에서 온전한 것은 3개뿐
- `launch.sh` → `f.sh` — 철자로 읽어도 안전하지 않음
